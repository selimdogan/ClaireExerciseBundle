...
class Equation extends Expression
{
     ...
     * Set leftExpression
     *
     * @param \SimpleIT\ExerciseBundle\Model\DomainKnowledge\Formula\Expression $leftExpression
     */
     ...
     * Set rightExpression
     *
     * @param \SimpleIT\ExerciseBundle\Model\DomainKnowledge\Formula\Expression $rightExpression
     */
    ...
    public function evaluate(array $parameters = array())
    {
        if (get_class($this->leftExpression) !==
            'SimpleIT\ExerciseBundle\Model\DomainKnowledge\Formula\Variable'
        ) {
