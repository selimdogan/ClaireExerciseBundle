...
class ItemResource
{
    ...
    /**
     * @const MULTIPLE_CHOICE_CLASS = 'SimpleIT\ApiResourcesBundle\Exercise\Exercise\MultipleChoice\Question'
     */
    const MULTIPLE_CHOICE_CLASS = 'SimpleIT\ApiResourcesBundle\Exercise\Exercise\MultipleChoice\Question';

    /**
     * @const OPEN_ENDED_QUESTION_CLASS ='SimpleIT\ApiResourcesBundle\Exercise\Exercise\OpenEndedQuestion\Question'
     */
    const OPEN_ENDED_QUESTION_CLASS ='SimpleIT\ApiResourcesBundle\Exercise\Exercise\OpenEndedQuestion\Question';

    /**
     * @const GROUP_ITEMS_CLASS = 'SimpleIT\ApiResourcesBundle\Exercise\Exercise\GroupItems\Item'
     */
    const GROUP_ITEMS_CLASS = 'SimpleIT\ApiResourcesBundle\Exercise\Exercise\GroupItems\Item';
     ...
     * @const GROUP_ITEMS_CLASS = 'SimpleIT\ApiResourcesBundle\Exercise\Exercise\GroupItems\Item'
     */
    const ORDER_ITEMS_CLASS = 'SimpleIT\ApiResourcesBundle\Exercise\Exercise\OrderItems\Item';

    /**
     * @const PAIR_ITEMS_CLASS = 'SimpleIT\ApiResourcesBundle\Exercise\Exercise\PairItems\Item'
     */
    const PAIR_ITEMS_CLASS = 'SimpleIT\ApiResourcesBundle\Exercise\Exercise\PairItems\Item';
     ...
     * @Serializer\Type("SimpleIT\ApiResourcesBundle\Exercise\Exercise\Common\CommonItem")
     ...
     * Set content
     *
     * @param \SimpleIT\ApiResourcesBundle\Exercise\Exercise\Common\CommonItem $content
     */
     ...
     * Get content
     *
     * @return \SimpleIT\ApiResourcesBundle\Exercise\Exercise\Common\CommonItem
     */
