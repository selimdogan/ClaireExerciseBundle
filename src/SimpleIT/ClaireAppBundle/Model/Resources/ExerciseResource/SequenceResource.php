...
class SequenceResource extends CommonResource
{
    ...
    /**
     * @var SequenceBlock
     * @Serializer\Type("SimpleIT\ApiResourcesBundle\Exercise\ExerciseResource\Sequence\SequenceBlock")
     * @Serializer\Groups({"details", "resource_storage", "resource_storage"})
     * @Assert\NotBlank(groups={"create"})
     * @Assert\Valid
     */
     ...
     * Set mainBlock
     *
     * @param \SimpleIT\ApiResourcesBundle\Exercise\ExerciseResource\Sequence\SequenceBlock $mainBlock
     */
     ...
     * Get mainBlock
     *
     * @return \SimpleIT\ApiResourcesBundle\Exercise\ExerciseResource\Sequence\SequenceBlock
     */
