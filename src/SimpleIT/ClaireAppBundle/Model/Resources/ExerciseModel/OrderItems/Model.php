...
class Model extends CommonModel
{
     ...
     * @Serializer\Type("SimpleIT\ApiResourcesBundle\Exercise\ExerciseModel\OrderItems\SequenceBlock")
     ...
     * @Serializer\Type("array<SimpleIT\ApiResourcesBundle\Exercise\ExerciseModel\OrderItems\ObjectBlock>")
     * @Serializer\Groups({"details", "exercise_model_storage"})
     */
