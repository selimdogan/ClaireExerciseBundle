...
class ExerciseResource
{
    ...
    /**
     * @const MULTIPLE_CHOICE_CLASS = 'SimpleIT\ApiResourcesBundle\Exercise\Exercise\MultipleChoice\Exercise'
     */
    const MULTIPLE_CHOICE_CLASS = 'SimpleIT\ApiResourcesBundle\Exercise\Exercise\MultipleChoice\Exercise';

    /**
     * @const GROUP_ITEMS_CLASS = 'SimpleIT\ApiResourcesBundle\Exercise\Exercise\GroupItems\Exercise'
     */
    const GROUP_ITEMS_CLASS = 'SimpleIT\ApiResourcesBundle\Exercise\Exercise\GroupItems\Exercise';
     ...
     * @const GROUP_ITEMS_CLASS = 'SimpleIT\ApiResourcesBundle\Exercise\Exercise\GroupItems\Exercise'
     */
    const ORDER_ITEMS_CLASS = 'SimpleIT\ApiResourcesBundle\Exercise\Exercise\OrderItems\Exercise';

    /**
     * @const PAIR_ITEMS_CLASS = 'SimpleIT\ApiResourcesBundle\Exercise\Exercise\PairItems\Exercise'
     */
    const PAIR_ITEMS_CLASS = 'SimpleIT\ApiResourcesBundle\Exercise\Exercise\PairItems\Exercise';

    /**
     * @const OPEN_ENDED_QUESTION_CLASS = 'SimpleIT\ApiResourcesBundle\Exercise\Exercise\OpenEndedQuestion\Exercise'
     */
    const OPEN_ENDED_QUESTION_CLASS = 'SimpleIT\ApiResourcesBundle\Exercise\Exercise\OpenEndedQuestion\Exercise';
     ...
     * @Serializer\Type("SimpleIT\ApiResourcesBundle\Exercise\Exercise\Common\CommonExercise")
     ...
     * Set content
     *
     * @param \SimpleIT\ApiResourcesBundle\Exercise\Exercise\Common\CommonExercise $content
     */
     ...
     * Get content
     *
     * @return \SimpleIT\ApiResourcesBundle\Exercise\Exercise\Common\CommonExercise
     */
