...
use SimpleIT\ApiResourcesBundle\Exercise\Exercise\PairItems\Exercise;
use SimpleIT\ApiResourcesBundle\Exercise\Exercise\PairItems\Item as ResItem;
use SimpleIT\ApiResourcesBundle\Exercise\ExerciseModel\Common\CommonModel;
use SimpleIT\ApiResourcesBundle\Exercise\ExerciseModel\PairItems\Model;
...
use SimpleIT\ExerciseBundle\Model\ModelObject\ObjectIdFactory;
...
class PairItemsService extends ExerciseCreationService
{
    ...
    {
        $exClass = 'SimpleIT\ApiResourcesBundle\Exercise\Exercise\PairItems\Exercise';
        /** @var ResItem $item */
