...
use SimpleIT\ApiResourcesBundle\Exercise\Exercise\OrderItems\Exercise;
use SimpleIT\ApiResourcesBundle\Exercise\Exercise\OrderItems\Item as ResItem;
...
class OrderItemsService extends ExerciseCreationService
{
    ...
    {
        $exClass = 'SimpleIT\ApiResourcesBundle\Exercise\Exercise\OrderItems\Exercise';
        /** @var ResItem $item */
    ...
    private function mergeObj(ExerciseTextObject $obj1, ExerciseTextObject $obj2)
    {
        if (
            get_class(
                $obj1
            ) === 'SimpleIT\ApiResourcesBundle\Exercise\ExerciseObject\ExerciseTextObject' &&
            get_class(
                $obj2
            ) === 'SimpleIT\ApiResourcesBundle\Exercise\ExerciseObject\ExerciseTextObject'
        ) {
