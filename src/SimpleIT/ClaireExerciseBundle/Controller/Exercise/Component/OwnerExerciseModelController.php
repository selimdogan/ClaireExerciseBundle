...
class OwnerExerciseModelController extends AppMetadataController
{
    ...
    {
        return $this->render(
            'SimpleITClaireExerciseBundle:Exercise/OwnerExerciseModel:browser.html.twig'
        );
    }
    ...
    public function editViewAction($ownerExerciseModelId)
    {
        ...
        return $this->render(
            'SimpleITClaireExerciseBundle:Exercise/OwnerExerciseModel:edit.html.twig',
            array(
    ...
    )
    {
        ...
        return $this->render(
            'SimpleITClaireExerciseBundle:Exercise/OwnerExerciseModel/Component:searchList.html.twig',
            array(
    ...
    )
    {
        ...
        return $this->render(
            'SimpleITClaireExerciseBundle:Exercise/OwnerExerciseModel/Component:list.html.twig',
            array(
                'ownerExerciseModels'   => $ownerExerciseModels,
                'collectionInformation' => $collectionInformation,
    ...
    public function editPublicViewAction($ownerExerciseModelId)
    {
        ...
        return $this->render(
            'SimpleITClaireExerciseBundle:Exercise/OwnerExerciseModel/Component:editPublic.html.twig',
