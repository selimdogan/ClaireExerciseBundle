...
class ResourceController extends AppController
{
    ...
    public function createResourceViewAction()
    {
        ...
        return $this->render(
            'SimpleITClaireExerciseBundle:Exercise/Resource:create.html.twig',
    ...
    public function editViewAction($resourceId)
    {
        ...
        return $this->render(
            'SimpleITClaireExerciseBundle:Exercise/Resource:edit.html.twig',
            array(
                'resource' => $resource,
                'locked'   => $locked
            )
    ...
    public function editTypeViewAction($resourceId, $locked = false)
    {
        ...
        return $this->render(
            'SimpleITClaireExerciseBundle:Exercise/Resource/Component:editType.html.twig',
    ...
    private function editPictureView(ResourceResource $resource, $locked)
    {
        ...
        return $this->render(
            'SimpleITClaireExerciseBundle:Exercise/Resource/Component:editPictureContent.html.twig',
            array('resource' => $resource, 'form' => $form->createView(), 'locked' => $locked)
        );
    }
    ...
    private function editTextView(ResourceResource $resource, $locked)
    {
        ...
        return $this->render(
            'SimpleITClaireExerciseBundle:Exercise/Resource/Component:editTextContent.html.twig',
            array('resource' => $resource, 'form' => $form->createView(), 'locked' => $locked)
        );
    }
    ...
    {
        return $this->render(
            'SimpleITClaireExerciseBundle:Exercise/Resource/Component:editMCQuestionContent.html.twig',
