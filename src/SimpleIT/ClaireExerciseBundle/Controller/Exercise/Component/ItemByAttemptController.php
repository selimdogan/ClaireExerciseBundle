...
class ItemByAttemptController extends AppController
{
    ...
    )
    {
        switch (get_class($exercise)) {
            case ExerciseResource::MULTIPLE_CHOICE_CLASS:
                $view = 'SimpleITClaireExerciseBundle:Exercise/Exercise/MultipleChoice/Component:corrected.html.twig';
                break;
            case ExerciseResource::GROUP_ITEMS_CLASS:
                $view = 'SimpleITClaireExerciseBundle:Exercise/Exercise/GroupItems/Component:corrected.html.twig';
                break;
            case ExerciseResource::ORDER_ITEMS_CLASS:
                $view = 'SimpleITClaireExerciseBundle:Exercise/Exercise/OrderItems/Component:corrected.html.twig';
                break;
            case ExerciseResource::PAIR_ITEMS_CLASS:
                $view = 'SimpleITClaireExerciseBundle:Exercise/Exercise/PairItems/Component:corrected.html.twig';
                break;
            default:
    ...
    )
    {
        switch (get_class($exercise)) {
            case ExerciseResource::MULTIPLE_CHOICE_CLASS:
                $view = 'SimpleITClaireExerciseBundle:Exercise/Exercise/MultipleChoice/Component:answerForm.html.twig';
                break;
            case ExerciseResource::GROUP_ITEMS_CLASS:
                $view = 'SimpleITClaireExerciseBundle:Exercise/Exercise/GroupItems/Component:answerForm.html.twig';
                break;
            case ExerciseResource::ORDER_ITEMS_CLASS:
                $view = 'SimpleITClaireExerciseBundle:Exercise/Exercise/OrderItems/Component:answerForm.html.twig';
                break;
            case ExerciseResource::PAIR_ITEMS_CLASS:
                $view = 'SimpleITClaireExerciseBundle:Exercise/Exercise/PairItems/Component:answerForm.html.twig';
                break;
            default:
                throw new \LogicException('Unknown class of exercise: ' . get_class($exercise));
        }
